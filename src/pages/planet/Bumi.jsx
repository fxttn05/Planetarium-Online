        ...
        <div className="max-w-3xl space-y-16">
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-3 text-xl text-gray-300 marker:text-red-500">
              <li>Satu-satunya planet dengan kehidupan</li>
              <li>70% permukaan tertutup air</li>
              <li>Memiliki atmosfer yang mendukung kehidupan</li>
              <li>Satu bulan alami: Bulan</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-xl leading-relaxed text-gray-300 ml-6">
              ...
              dengan permukaan yang sebagian besar tertutup air. Atmosfernya
              kaya akan oksigen dan memiliki lapisan ozon yang melindungi
              kehidupan dari radiasi matahari yang berbahaya.
            </p>
          </section>
